...
- Have [VLC media player](https://www.videolan.org/vlc/) **3.x** installed (64-bit VLC with 64-bit Java, or 32-bit with 32-bit). edus2j uses LibVLC via vlcj for scan video playback. VLC 4.x is not supported.
