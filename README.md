...
- Have [VLC media player](https://www.videolan.org/vlc/) installed. edus2j uses LibVLC via vlcj for scan video playback. The bitness of VLC must match the bitness of your JRE (e.g. 64-bit Java requires 64-bit VLC).
